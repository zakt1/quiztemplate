...
import quizData from '../../components/data';
 ...
 const ReadQuizQn =() =>{
    ...
    const tempQuestObj = {}
    tempQuestion.map(() => {
        tempQuestObj.question = tempQuestion[0]
        tempQuestObj.option1 = tempQuestion[1]
        tempQuestObj.option2 = tempQuestion[2]
        tempQuestObj.option3 = tempQuestion[3]
        tempQuestObj.option4 = tempQuestion[4]


    })
    // console.log(tempQuestObj, '<< tempQuestObj')
